...
function Busca() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-4">Encontre no Mostra e Vende e veja ofertas na web</p>
          ...
          <div className="mt-6">
            ...
            {!loading && done && items.length === 0 && (
              <div className="card p-5 text-center text-gray-500">
                Nenhum anúncio encontrado no Mostra e Vende. <Link href="/market/new" className="text-brand underline">Anuncie você mesmo!</Link>
              </div>
            )}
