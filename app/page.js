  ...
  return (
    <div>
      <Link href="/descubra" className="block rounded-2xl overflow-hidden mb-5 bg-gradient-to-r from-fuchsia-600 to-brand text-white p-5 shadow-lg hover:opacity-95 transition">
        ...
        <p className="text-lg font-extrabold mt-2 leading-tight">Veja o que tá bombando hoje no Vai Lá</p>
        <p className="text-white/90 text-sm">Notícias, famosos e curiosidades → toque para Descobrir</p>
      </Link>
